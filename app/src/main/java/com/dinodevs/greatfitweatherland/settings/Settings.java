...
import com.dinodevs.greatfitweatherland.CustomDataUpdater;
import com.dinodevs.greatfitweatherland.GreatFitWeatherLandSlpt;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        settings.add(new ButtonSetting(getString(R.string.save), getDrawable(R.drawable.green_button), new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                startService(new Intent(getApplicationContext(), GreatFitWeatherLandSlpt.class));
                // Kill this
